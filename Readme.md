...
- Structure of URL line and HTML5 History API
- Components BrowserRouter and Route
- Work with 404 Error with Redirect
- Component Switch
- Components Link & NavLink
- Deep Routes and navigation (match.url & match.path)
